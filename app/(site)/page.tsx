        ...
        >
          <div className="flex flex-col items-center">
            ...
            <p className="mt-2 max-w-md text-sm text-slate-600">
              Browse 140-point quality checked pre-owned cars with transparent pricing and history.
            </p>
          </div>
          <Link href="/pre-owned-cars" className="btn btn-primary mt-6 w-full sm:w-auto">
            Browse Cars
          </Link>
        </Reveal>
      </section>
