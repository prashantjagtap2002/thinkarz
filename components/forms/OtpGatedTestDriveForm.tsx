          ...
          <div className="mb-6">
            ...
            <div className="flex h-[42px] overflow-hidden rounded-[6px] border border-[#cbd5e1] bg-white focus-within:border-[#e31e24] focus-within:ring-1 focus-within:ring-[#e31e24]">
              <select
                ...
                className="flex items-center justify-center border-r border-[#cbd5e1] bg-slate-50 px-3.5 text-[14px] text-slate-600 outline-none appearance-none cursor-pointer hover:bg-slate-100 transition-colors"
